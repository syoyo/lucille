...
extern void ri_parallel_init(int *argc, char ***argv);
...
extern void ri_parallel_bcast(void *src, size_t size);  
extern void ri_parallel_gather(void *src, void *dst, size_t size);  
extern void ri_parallel_send(void *src, size_t size, int dest, int tag);  
extern void ri_parallel_recv(void *src, size_t size, int source, int tag,
			     ri_parallel_status_t *status);  
extern void ri_parallel_irecv(void *src, size_t size, int source, int tag,
