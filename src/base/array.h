 ...
 *
 * We privide two kind of dyamic array, ri_array and ri_ptr_array.
 *
 * ri_array allocate memory for array element and maintains content of array
 * element, whereas ri_ptr_array stores just a pointer to data.
 *
