...
| atmosphere STRING param_list
{
    RiAtmosphereV($2, rib_param_num, rib_param_tokens, rib_param_args);
}
| clipping NUM NUM
{
    RiClipping($2, $3);
...
| displacement STRING param_list
{
    RiDisplacementV($2, rib_param_num, rib_param_tokens, rib_param_args);
}
...
;
atmosphere              : ATMOSPHERE            { enter_mode_param();    }
;
...
;
displacement            : DISPLACEMENT          { enter_mode_param();    }
;
