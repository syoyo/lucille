...
void
ri_geom_add_positions(ri_geom_t          *geom,
...
void
ri_geom_add_normals(ri_geom_t          *geom,
...
void
ri_geom_add_tangents(ri_geom_t          *geom,
...
void
ri_geom_add_binormals(ri_geom_t          *geom,
...
void
ri_geom_add_colors(ri_geom_t          *geom,
...
void
ri_geom_add_opacities(ri_geom_t          *geom,
...
void
ri_geom_add_texcoords(ri_geom_t     *geom,
...
void
ri_geom_add_indices(ri_geom_t          *geom,
