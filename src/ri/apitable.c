...
{
    ri_log_once(LOG_WARN, "(RI    ) RiFrameBegin() is not yet implemented, ignored.");
...
RiFrameEnd(void)
{
    ri_log_once(LOG_WARN, "(RI    ) RiFrameEnd() is not yet implemented, ignored.");
    //ri_api_frame_end();
}
...
{
    ri_log_once(LOG_WARN, "(RI    ) RiShadingRate() is not yet implemented");
    (void)size;
}
...
{
    ri_log_once(LOG_WARN, "(RI    ) RiShadingInterpolation() is not yet implemented, ignored.");
    (void)type;
}
...
{
    ri_log_once(LOG_WARN, "(RI    ) RiShutter() is not yet implemented, ignored.");
    (void)min;
    (void)max;
}
...
{
    ri_log_once(LOG_WARN, "(RI    ) RiPixelFilter() is not yet implemented, ignored.");
    (void)filterfunc;
    (void)xwidth;
    (void)ywidth;
}
...
{
    ri_log_once(LOG_WARN, "(RI    ) RiQuantize() is not yet implemented, ignored.");
    (void)type;
    (void)one;
    (void)min;
    (void)max;
...
{
    ri_log_once(LOG_WARN, "(RI    ) RiCoordinateSystem() is not yet implemented, ignored.");
    (void)space;
}
...
{
    ri_log_once(LOG_WARN, "(RI    ) RiIlluminate() is not yet implemented, ignored.");
    (void)light;
    (void)onoff;
}
...
{
    ri_log_once(LOG_WARN, "(RI    ) RiDisplacementV() is not yet implemented, ignored.");
    (void)name;
    (void)n;
    (void)tokens;
    (void)params;
...
{
    ri_log_once(LOG_WARN, "(RI    ) RiAtomosphereV() is not yet implemented, ignored.");
    (void)name;
    (void)n;
    (void)tokens;
    (void)params;
...
{
    ri_log_once(LOG_WARN, "(RI    ) RiPointsV() is not yet implemented, ignored.");
    (void)npoints;
    (void)n;
    (void)tokens;
    (void)params;
...
{
    ri_log_once(LOG_WARN, "(RI    ) RiBasis() is not yet implemented, ignored.");
    (void)ubasis;
    (void)ustep;
    (void)vbasis;
    (void)vstep;
...
{
    ri_log_once(LOG_WARN, "(RI    ) RiMatte() is not yet implemented, ignored.");
    (void)onoff;
}
...
{
    ri_log_once(LOG_WARN, "(RI    ) RiMotionBegin() is not yet implemented, ignored.");
    (void)n;
...
{
    ri_log_once(LOG_WARN, "(RI    ) RiMotionBeginV() is not yet implemented, ignored.");
    (void)n;
    (void)times;
}
...
RiMotionEnd()
{
    ri_log_once(LOG_WARN, "(RI    ) RiMotionEnd() is not yet implemented, ignored.");
}
...
RiTrimCurve(RtInt nloops, RtInt ncurves[], RtInt order[], RtFloat knot[],
        ...
        RtFloat w[])
{
    ri_log_once(LOG_WARN, "(RI    ) RiTrimCurve() will not be implemented, ignored.");
    (void)nloops;
    (void)ncurves;
    (void)order;
    (void)knot;
...
RiPatchV(
    ...
    RtPointer params[])
{
    ri_log_once(LOG_WARN, "(RI    ) RiPatch() is not yet implemened, ignored.");
...
RiPatchMeshV(
    ...
    RtPointer params[])
{
    ri_log_once(LOG_WARN, "(RI    ) RiPatchMesh() is not yet implemened, ignored.");
    (void)type;
    (void)nu;
    (void)uwrap;
    (void)nv;
...
RiNuPatchV(RtInt nu, RtInt uorder, RtFloat uknot[], RtFloat umin, RtFloat umax,
       ...
       RtInt n, RtToken tokens[], RtPointer params[])
{
    ri_log_once(LOG_WARN, "(RI    ) RiNuPatchV() will not be implemented, ignored.");
    (void)nu;
    (void)uorder;
    (void)uknot;
    (void)umin;
...
RiCurvesV(RtToken type, RtInt ncurves, RtInt nvertices[], RtToken wrap,
      RtInt n, RtToken tokens[], RtPointer params[])
{
    ri_log_once(LOG_WARN, "(RI    ) RiCurvesV() will not be implemented, ignored.");
    (void)type;
    (void)ncurves;
    (void)nvertices;
    (void)wrap;
...
{
    ri_log_once(LOG_WARN, "(RI    ) RiArchiveRecord() is not yet implemented, ignored.");
    (void)type;
    (void)format;
...
{
    ri_log_once(LOG_WARN, "(RI    ) RiErrorHandler() is not yet implemented, ignored.");
    (void)handler;
}
