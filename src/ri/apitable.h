...
/* options */
extern void ri_api_format            (RtInt     xresplution,
                                      RtInt     yresolution,
                                      RtFloat   aspect);

extern void ri_api_frame_aspect_ratio(RtFloat   aspect);

extern void ri_api_screen_window     (RtFloat   left,
                                      RtFloat   right,
                                      RtFloat   bot,
                                      RtFloat   top);

extern void ri_api_crop_window       (RtFloat   xmin,
                                      RtFloat   xmax,
                                      RtFloat   ymin,
                                      RtFloat   ymax);
...
extern void ri_api_clipping          (RtFloat   hither, 
                                      RtFloat   yon);

extern void ri_api_clipping_plane    (RtFloat   x,
                                      RtFloat   y,
                                      RtFloat   z,
                                      RtFloat   nx,
                                      RtFloat   ny,
...
extern void ri_api_depth_of_field    (RtFloat   fstop,
                                      RtFloat   focallength,
                                      RtFloat   focaldistance);

extern void ri_api_shutter           (RtFloat   min,
                                      RtFloat   max);

extern void ri_api_exposure          (RtFloat   gain,
                                      RtFloat   gamma);

extern void ri_api_display           (char     *name,
                                      RtToken   type,
                                      RtToken   mode,
                                      RtInt     n,
                                      RtToken   tokens[],
...
extern void ri_api_pixel_samples     (RtFloat   xsamples,
                                      RtFloat   ysamples);

extern void ri_api_option            (RtToken   name,
                                      RtInt     n,
                                      RtToken   tokens[],
                                      RtPointer params[]);
...
extern void ri_api_translate         (RtFloat   dx,
                                      RtFloat   dy,
                                      RtFloat   dz);

extern void ri_api_rotate            (RtFloat   angle,
                                      RtFloat   dx,
                                      RtFloat   dy,
                                      RtFloat   dz);

extern void ri_api_scale             (RtFloat   sx,
                                      RtFloat   sy,
                                      RtFloat sz);

/* lights */
extern RtLightHandle ri_api_area_light_source(
                                      RtToken   name,
                                      RtInt     n,
                                      RtToken   tokens[],
                                      RtPointer params[]);

extern RtLightHandle ri_api_light_source(
                                      RtToken   name,
                                      RtInt     n,
                                      RtToken   tokens[],
                                      RtPointer params[]);

extern void ri_api_sphere            (RtFloat   radius,
                                      RtFloat   zmin,
                                      RtFloat   zmax,
                                      RtFloat   tmax,
                                      RtInt     n,
