...
calc_bbox(ri_list_t *geom_list, double min[3], double max[3])
{
	...
	for (itr  = ri_list_first(geom_list);
		...
		for (i = 0; i < geom->npositions; i++) {
			...
			if (min[0] > v.f[0]) min[0] = v.f[0];	
			if (min[1] > v.f[1]) min[1] = v.f[1];	
			if (min[2] > v.f[2]) min[2] = v.f[2];	

			if (max[0] < v.f[0]) max[0] = v.f[0];	
			if (max[1] < v.f[1]) max[1] = v.f[1];	
			if (max[2] < v.f[2]) max[2] = v.f[2];	
		}
	}
}
...
{
	min[0] = v[0].f[0] < v[1].f[0] ? v[0].f[0] : v[1].f[0];
	min[0] = min[0] < v[2].f[0] ? min[0] : v[2].f[0];
	min[1] = v[0].f[1] < v[1].f[1] ? v[0].f[1] : v[1].f[1];
	min[1] = min[1] < v[2].f[1] ? min[1] : v[2].f[1];
	min[2] = v[0].f[2] < v[1].f[2] ? v[0].f[2] : v[1].f[2];
	min[2] = min[2] < v[2].f[2] ? min[2] : v[2].f[2];

	max[0] = v[0].f[0] > v[1].f[0] ? v[0].f[0] : v[1].f[0];
	max[0] = max[0] > v[2].f[0] ? max[0] : v[2].f[0];
	max[1] = v[0].f[1] > v[1].f[1] ? v[0].f[1] : v[1].f[1];
	max[1] = max[1] > v[2].f[1] ? max[1] : v[2].f[1];
	max[2] = v[0].f[2] > v[1].f[2] ? v[0].f[2] : v[1].f[2];
	max[2] = max[2] > v[2].f[2] ? max[2] : v[2].f[2];
}
...
copy_simd(ri_tri_list_t *dst)
{
	...
	for (j = 0; j < nblocks - 1; j++) {
		for (i = 0; i < 4; i++) {
			...
			simdinfo->tridata.aligned[36 * j +  8 + i] = v0.f[2];
			simdinfo->tridata.aligned[36 * j + 12 + i] = e1.f[0];
			simdinfo->tridata.aligned[36 * j + 16 + i] = e1.f[1];
			simdinfo->tridata.aligned[36 * j + 20 + i] = e1.f[2];
			simdinfo->tridata.aligned[36 * j + 24 + i] = e2.f[0];
			simdinfo->tridata.aligned[36 * j + 28 + i] = e2.f[1];
			simdinfo->tridata.aligned[36 * j + 32 + i] = e2.f[2];
	...
	for (i = 0; i < nextra; i++) {
		...
		simdinfo->tridata.aligned[36 * offset +  8 + i] = v0.f[2];
		simdinfo->tridata.aligned[36 * offset + 12 + i] = e1.f[0];
		simdinfo->tridata.aligned[36 * offset + 16 + i] = e1.f[1];
		simdinfo->tridata.aligned[36 * offset + 20 + i] = e1.f[2];
		simdinfo->tridata.aligned[36 * offset + 24 + i] = e2.f[0];
		simdinfo->tridata.aligned[36 * offset + 28 + i] = e2.f[1];
		simdinfo->tridata.aligned[36 * offset + 32 + i] = e2.f[2];
