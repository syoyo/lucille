...
/*
 * BRDF interface class
 */
typedef struct _ri_brdf_t
{
    int brdf_type;            /* brdf type (lambert, blinn, etc...)    */

    /*
     * Evaluate BRDF: Br(wo, wi, n)
     */
    int (*eval)(    const ri_vector_t    wo,
                    const ri_vector_t    wi,
                    const ri_vector_t    n,         /* normal       */
                    const ri_vector_t    b,         /* bi-normal    */
                    const ri_vector_t    t);        /* tangent      */
                
    /*
     * Sample BRDF according to CDF(Cummulative Density Function).
     */
    int (*sample)(  ri_vector_t          wo_out,    /* [out]        */
                    ri_float_t          *pdf_out,   /* [out]        */
                    const ri_vector_t    wi,        /* incident     */
                    const ri_vector_t    n,         /* normal       */
                    const ri_vector_t    b,         /* bi-normal    */
                    const ri_vector_t    t);        /* tangent      */


    void *param;                            /* BRDF specific param */
...
extern void   ri_brdf_ashikhmin_shirley_spf(
    ri_vector_t        specularray_out,     /* [out] */
    ri_vector_t        diffuseray_out,      /* [out] */
    ri_float_t        *specularfactor_out,  /* [out] */
    ri_float_t        *diffusefactor_out,   /* [out] */
